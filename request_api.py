...
@click.option('--file-path', default='https://raw.githubusercontent.com/rstudio/cheatsheets/main/data-visualization.pdf', help='要上传的文件路径或URL')
@click.option('--mode', type=click.Choice(['upload', 'chunk', 'both']), default='both', help='测试模式: upload(仅上传), chunk(仅分块), both(两者都测试)')
